...
public class EmotionAnalyzerService {
    ...
    static {
        ...
        EMOTION_KEYWORDS.put("miedo", "Temor");
        EMOTION_KEYWORDS.put("esperanza", "Esperanza");
        EMOTION_KEYWORDS.put("aventura", "Asombro");
        ...
        EMOTION_KEYWORDS.put("comedia", "Alegría");
        EMOTION_KEYWORDS.put("terror", "Pánico");
        EMOTION_KEYWORDS.put("horror", "Pánico");
        EMOTION_KEYWORDS.put("sorpresa", "Sorpresa");
        EMOTION_KEYWORDS.put("drama", "Nostalgia");
        EMOTION_KEYWORDS.put("acción", "Euforia");
        EMOTION_KEYWORDS.put("ciencia ficción", "Curiosidad");
        EMOTION_KEYWORDS.put("superhéroes", "Grandeza");
        EMOTION_KEYWORDS.put("thriller", "Tensión");
        EMOTION_KEYWORDS.put("suspenso", "Tensión");
        EMOTION_KEYWORDS.put("policial", "Desconfianza");
        EMOTION_KEYWORDS.put("crimen", "Desconfianza");
        EMOTION_KEYWORDS.put("persecución", "Euforia");
        ...
        EMOTION_KEYWORDS.put("viaje en el tiempo", "Asombro");
        EMOTION_KEYWORDS.put("desamor", "Tristeza");
        ...
        EMOTION_KEYWORDS.put("superación", "Hope Core");
